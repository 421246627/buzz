...
public class hotelController {
    ...
    @Resource
    com.buzz.service.scenicspotService scenicspotService;

    @Resource
    com.buzz.service.hotelCollectService hotelCollectService;

    @Resource
    com.buzz.service.hotelOrdersService hotelOrdersService;

    @Resource
    com.buzz.service.cityService cityService;

    @Resource
    com.buzz.service.provinceService provinceService;
    ...
    public String hotelIndex(Model model, HttpServletRequest request,String scenicspotId,String cityId){
        ...
        if(cityId==null||cityId.equals("")){
            city=(com.buzz.entity.city) request.getServletContext().getAttribute("city");
        }else{
    ...
    public String hotelDetailsIndex(Model model, String hotelId, HttpSession session){
        ...
        if(session.getAttribute("user")!=null){
            users users= (com.buzz.entity.users) session.getAttribute("user");
