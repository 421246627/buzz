...
public class strategyController {
    ...
    public String queryCityStrategy(Model model, HttpServletRequest request,String strategyId){
        //保存当前城市对象
        city city=(com.buzz.entity.city) request.getServletContext().getAttribute("city");
        ...
        if(strategyList.size()>0) {
            ...
            //保存其他的攻略
            List<com.buzz.entity.strategy> OtherStrategy=strategyService.queryOhterStrategy(strategy.getStrategyId(),city.getCityId());
    ...
    public String byStrategyIdQueryStrategy(String id,String deleteImage) throws FileNotFoundException {
        ...
        if(strategy.getStrategyPhoto().split(",").length>1){
            ...
            //重新获取景点图片返回
            com.buzz.entity.strategy strategy1=strategyService.byStrategyIdQueryStrategy(id);
    ...
    public String setHeadPhoto(String strategyId,String photo){
        ...
        //3.返回攻略图片属性
        com.buzz.entity.strategy strategy1=strategyService.byStrategyIdQueryStrategy(strategyId);
        return strategy1.getStrategyPhoto();
    }
    /**
     * 获取下载数量最多的五个旅游攻略
