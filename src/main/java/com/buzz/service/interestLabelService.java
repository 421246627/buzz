...
public class interestLabelService
{
    ...
    public Paging<interestLabel> PagingQuery(Integer page, Integer rows, interestLabel interestLabel){
        ...
        List<com.buzz.entity.interestLabel> interestLabels=interestlabeldao.queryAll(interestLabel);
        return new Paging<com.buzz.entity.interestLabel>(interestLabels,total);
    }
